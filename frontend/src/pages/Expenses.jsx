...
export default function Expenses() {
  ...
  const { items, loading, error, success } = useSelector((state) => state.expenses);
  ...
  const filteredExpenses = items.filter((exp) =>
                  ...
                  <tr key={expense._id} className="border-b border-gray-100 hover:bg-gray-50 transition">
                    ...
                    <td className="py-3 px-4">
                      <div className="flex items-center gap-2">
                        {expense.approvalStatus === 'pending' && (
                          <>
                            <button onClick={() => handleOpenModal(expense)} className="text-blue-600 hover:text-blue-700 transition">
                              <Edit2 size={18} />
                            </button>
                            <button onClick={() => handleDelete(expense._id)} className="text-red-600 hover:text-red-700 transition">
                              <Trash2 size={18} />
                            </button>
                          </>
                        )}
                        {user?.role === 'director' && expense.approvalStatus === 'pending' && (
                          <>
                            <button onClick={() => handleApprove(expense._id)} className="text-green-600 hover:text-green-700 transition">
                              <CheckCircle size={18} />
                            </button>
                            <button onClick={() => handleReject(expense._id)} className="text-red-600 hover:text-red-700 transition">
                              <XCircle size={18} />
                            </button>
                          </>
                        )}
            ...
            <form onSubmit={handleSubmit} className="p-6 space-y-4">
              ...
              <div className="flex gap-3 pt-4 border-t border-gray-200">
                ...
                >
                  ...
                  {loading ? 'Saving...' : editingId ? 'Update Expense' : 'Create Expense'}
                </button>
                <button
                  type="button"
